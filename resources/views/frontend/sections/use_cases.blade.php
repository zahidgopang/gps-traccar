...
<section id="use-cases" class="py-32 relative overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
            @php
                $useCases = __('frontend.use_cases.items');
            @endphp
        ...
        <div class="p-8 rounded-2xl glass border border-slate-700/50">
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="grid grid-cols-3 gap-4">
                    <div class="p-4 rounded-lg bg-slate-800/50 text-center hover:bg-slate-800 transition-colors cursor-pointer group">
                        <div class="text-2xl mb-2 group-hover:scale-110 transition-transform">🏥</div>
                        <div class="text-sm text-slate-300">Healthcare</div>
                    </div>
                    <div class="p-4 rounded-lg bg-slate-800/50 text-center hover:bg-slate-800 transition-colors cursor-pointer group">
                        <div class="text-2xl mb-2 group-hover:scale-110 transition-transform">⚡</div>
                        <div class="text-sm text-slate-300">Utilities</div>
                    </div>
                    <div class="p-4 rounded-lg bg-slate-800/50 text-center hover:bg-slate-800 transition-colors cursor-pointer group">
                        <div class="text-2xl mb-2 group-hover:scale-110 transition-transform">🌱</div>
                        <div class="text-sm text-slate-300">Agriculture</div>
                    </div>
                    <div class="p-4 rounded-lg bg-slate-800/50 text-center hover:bg-slate-800 transition-colors cursor-pointer group">
                        <div class="text-2xl mb-2 group-hover:scale-110 transition-transform">🚧</div>
                        <div class="text-sm text-slate-300">Construction</div>
                    </div>
                    <div class="p-4 rounded-lg bg-slate-800/50 text-center hover:bg-slate-800 transition-colors cursor-pointer group">
                        <div class="text-2xl mb-2 group-hover:scale-110 transition-transform">🎓</div>
                        <div class="text-sm text-slate-300">Education</div>
                    </div>
                    <div class="p-4 rounded-lg bg-slate-800/50 text-center hover:bg-slate-800 transition-colors cursor-pointer group">
                        <div class="text-2xl mb-2 group-hover:scale-110 transition-transform">👮</div>
                        <div class="text-sm text-slate-300">Government</div>
                    </div>
                </div>
            </div>
        </div>
