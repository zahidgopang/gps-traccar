...
<style>
    ...
    .invoice-print-doc__brand { font-size: 1.25rem; font-weight: 700; letter-spacing: 0.02em; }
    .invoice-print-doc__title { font-size: 1.1rem; font-weight: 600; text-transform: uppercase; letter-spacing: 0.06em; }
    ...
    .invoice-print-doc table th { padding: 0.55rem 0.5rem; vertical-align: middle; }
    ...
    @media screen { .print-only-code { display: none; } }

    @media print {
        @page { size: A4; margin: 12mm 14mm; }
        body { background: #fff !important; color: #000 !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
        .admin-sidebar, .admin-navbar, .sidebar-overlay, .footer-premium, .no-print, .no-print-inline { display: none !important; }
        .print-only-code { display: inline !important; }
        ...
        .content-wrap, main { padding: 0 !important; margin: 0 !important; max-width: 100% !important; }
        .invoice-print-doc { border: none !important; border-radius: 0 !important; padding: 0 !important; box-shadow: none !important; }
        .invoice-print-doc a { color: #000 !important; text-decoration: none !important; }
        .invoice-print-doc .badge { border: 1px solid #333 !important; color: #000 !important; background: transparent !important; }
...
@section('content')
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3 no-print">
        ...
        <div class="d-flex gap-1 flex-wrap">
            <button type="button" class="btn btn-sm btn-outline-secondary" onclick="window.print()" id="print">
                <i class="fas fa-print me-1" aria-hidden="true"></i>{{ __('app.admin.stock_sales.print') }}
            </button>
            <a href="{{ route('client.purchases.index') }}" class="btn btn-sm btn-light">
                ...
                @foreach($sale->items as $index => $item)
                    <tr>
                        ...
                        <td class="admin-ltr" dir="ltr">
                            ...
                            <span class="no-print-inline">{{ $item->stockOrder?->order_code }}</span>
                        </td>
                        <td>
