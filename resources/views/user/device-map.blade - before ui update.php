...
@push('styles')
    <style>
        ...
        /* ============================================
           PLAYBACK CONTROLS (PREMIUM VERSION ONLY)
        ============================================ */
        #playbackControls {
            position: absolute;
            bottom: 15px;
            ...
            z-index: 1;  /* stays behind sidebar */
        }
        ...
        #geofenceList::-webkit-scrollbar,
        #geofenceManageList::-webkit-scrollbar {
            width: 4px;
        }
        #geofenceList::-webkit-scrollbar-thumb,
        #geofenceManageList::-webkit-scrollbar-thumb {
...
@push('scripts')
    <script>
        ...
        const IDLE_TIME_THRESHOLD_SECONDS = 5 * 60; // 5 minutes
        let historyData = [];
        ...
        function processRouteData(data) {
            const summary = { distanceKm:0, durationSec:0, avgSpeedKmh:0, idleEvents:0, idleTotalSec:0 };
        ...
        document.getElementById('reverseBtn').addEventListener('click', async ()=>{
            ...
            document.getElementById('addressBox').innerText = j.display_name ?? 'Address not found';
        });
